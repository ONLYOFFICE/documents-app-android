...
class UploadWork(context: Context, workerParameters: WorkerParameters): Worker(context, workerParameters) {
    ...
    private val mNotificationUtils: NewNotificationUtils = NewNotificationUtils(applicationContext, app.editors.manager.storages.onedrive.managers.works.UploadWork.TAG)
