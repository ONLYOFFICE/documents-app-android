...
class WebViewerFragment : BaseAppFragment(), OnRefreshListener {
    ...
    companion object {
        ...
        private const val DESKTOP_USER_AGENT =
            "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2049.0 Safari/537.36 AndroidWebView"
        private const val MOBILE_USER_AGENT =
            "Mozilla/5.0 (Linux; U; Android 4.4; en-us; Nexus 4 Build/JOP24G) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30 AndroidWebView"
