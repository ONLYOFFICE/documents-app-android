...
public class File extends Item implements Serializable, Entity, Cloneable {
    ...
    * Comparators
    * */
    public static class SortFilesType extends Base.AbstractSort<File> {
    ...
    public static class SortFilesSize extends Base.AbstractSort<File> {
