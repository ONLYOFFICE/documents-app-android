...
class GoogleDriveSignInFragment: BaseAppFragment(), SwipeRefreshLayout.OnRefreshListener,
    GoogleDriveSignInView {
    ...
    private fun init(savedInstanceState: Bundle?) {
        ...
        viewBinding?.webStorageSwipe?.apply {
            setOnRefreshListener(this@GoogleDriveSignInFragment)
