...
class SocialViews(
    ...
    * */
    ...
    private fun initListeners() {
        viewBinding?.let {
            ...
            it.loginSocialTwitterButton.setOnClickListener {
                onSocialNetworkCallbacks?.onSocialClick(ApiContract.Social.TWITTER)
            }
        }
    }
    ...
    * */
    ...
    companion object {
        val TAG: String = SocialViews::class.java.simpleName
